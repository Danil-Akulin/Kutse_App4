    ...
    public class HomeController : Controller
    {
        ...
        public void E_mail(Guest guest)
        {
            ...
            try
            {
                ...
                WebMail.SmtpPort = 587;
                WebMail.EnableSsl = true;
                WebMail.UserName = "danil23akulin@gmail.com";
                WebMail.Password = "aseskaljan123";
                WebMail.From = "danil23akulin@gmail.com";
                WebMail.Send("danil23akulin@gmail.com", "Vastus kutsele",guest.Name + " vastas " + ((guest.WillAttend ?? false) ?
        ...
        public void E_mailGuest(Guest guest)
        {
                ...
                WebMail.From = "danil23akulin@gmail.com";
            //WebMail.Send(komu, "Napominanie","ne zabud pridi");
                WebMail.Send("danil23akulin@gmail.com", "Meeldetuletus", guest.Name + "vastas" + ((guest.WillAttend ?? false) ?
                    "tuleb people " : "ei tule people"));
                ViewBag.Message = "Kiri on saatnud!";
        }
